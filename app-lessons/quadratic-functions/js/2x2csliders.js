$(document).ready(function(){
    ...
    $('#slider1').on('moved.zf.slider', function(){
        ...
        var newEquation = currentCoefficients.x2 + 'x^2 + ' + currentCoefficients.c;
        ...
        if (valueOfSlider1 > 1){
            ...
            newEquation = 'x^2 + ' + currentCoefficients.c;
    ...
    $('#slider3').on('moved.zf.slider', function(){
        ...
        var newEquation3 = currentCoefficients.x2 + 'x^2 + ' + currentCoefficients.c;
